...
describe RssFeedsController do
  ...
  describe "GET index" do
    it "assigns all rss_feeds as @rss_feeds" do
      ...
      assigns(:rss_feeds).should eq([rss_feed])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested rss_feed as @rss_feed" do
      ...
      assigns(:rss_feed).should eq(rss_feed)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new rss_feed as @rss_feed" do
      ...
      assigns(:rss_feed).should be_a_new(RssFeed)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created rss_feed as @rss_feed" do
        post :create, {:rss_feed => valid_attributes}, valid_session
        assigns(:rss_feed).should be_a(RssFeed)
        assigns(:rss_feed).should be_persisted
      end

      it "redirects to the created rss_feed" do
        post :create, {:rss_feed => valid_attributes}, valid_session
        response.should redirect_to(RssFeed.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rss_feed as @rss_feed" do
        ...
        RssFeed.any_instance.stub(:save).and_return(false)
        post :create, {:rss_feed => { "title" => "invalid value" }}, valid_session
        assigns(:rss_feed).should be_a_new(RssFeed)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rss_feed" do
        rss_feed = RssFeed.create! valid_attributes
        # Assuming there are no other rss_feeds in the database, this
        # specifies that the RssFeed created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        RssFeed.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => rss_feed.to_param, :rss_feed => { "title" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the rss_feed" do
        rss_feed = RssFeed.create! valid_attributes
        put :update, {:id => rss_feed.to_param, :rss_feed => valid_attributes}, valid_session
        response.should redirect_to(rss_feed)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the rss_feed as @rss_feed" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        RssFeed.any_instance.stub(:save).and_return(false)
        put :update, {:id => rss_feed.to_param, :rss_feed => { "title" => "invalid value" }}, valid_session
        assigns(:rss_feed).should eq(rss_feed)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the rss_feeds list" do
      rss_feed = RssFeed.create! valid_attributes
      delete :destroy, {:id => rss_feed.to_param}, valid_session
      response.should redirect_to(rss_feeds_url)
    end
  end
